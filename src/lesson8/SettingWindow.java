...
public class SettingWindow extends JFrame {
    ...
    static final int WINDOW_WIDTH_ = 400;
    ...
    private JSlider slWinningLenght;
    ...
    public SettingWindow(GameWindow gameWindow) {
        ...
        slWinningLenght = new JSlider(MIN_FIELD_SIZE,MIN_FIELD_SIZE,MIN_FIELD_SIZE);
        slWinningLenght.setMajorTickSpacing(1);
        slWinningLenght.setPaintLabels(true);
        slWinningLenght.setPaintTicks(true);
        add(slWinningLenght);
        ...
        slFieldSize.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                slWinningLenght.setMaximum(slFieldSize.getValue());
            }
        });
        ...
        btnNewGame.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int winningLenght = slWinningLenght.getValue();

                Logic.SIZE = size;
                Logic.DOTS_TO_WIN = winningLenght;
                Logic.initMap();
                Logic.gameFinished = false;


                gameWindow.startNewGame(size, winningLenght);
                setVisible(false);
            }
        });
